...
export default function MainLayout({ children }: Props) {
  ...
  return (
    <ProtectedRoute>
      <ProfileProvider>
        <PostProvider>
          <div className="h-fit block dark:bg-cushion bg-white md:flex relative 3xl:w-[1600px] mx-auto w-full after:absolute after:inset-0 after:z-99  after:shadow-wrapper after:pointer-events-none">
            {isSmallScreen || <Sidebar className="dark:bg-surface-3 bg-[#e8e8e8e5]" />}
            <Main>{children}</Main>
