...
const AvatarProfile = ({ avatar, canEdit }: AvatarProfileProps) => {
    ...
    return (
        <>
            <div
                className={`w-fit absolute flex justify-center items-center left-[20px] -bottom-[36px] z-1 rounded-full border-[4px] dark:border-[#303030] border-[#c7c7c7] overflow-hidden ${canEdit && 'after:content-[""] after:absolute after:bg-[#12121299] after:inset-0'}`}
            >
