...
export default function ThemeAutoBox() {
  ...
  return (
    <div className={style.themeAutoContainer}>
      <div className={theme === "dark" ? `${style.backgroundLightHalf} ${style.dark}` : theme==="light" ? `${style.backgroundLightHalf} ${style.light}` : systemTheme === "dark" ? `${style.backgroundLightHalf} ${style.dark}` : `${style.backgroundLightHalf} ${style.light}`}>
