...
export default function ThemeLightBox() {
  ...
  return (
    <div className={theme === 'dark' ? `${style.backgroundLight} ${style.dark}` : theme ==="light" ? `${style.backgroundLight} ${style.light}` : systemTheme === "dark" ? `${style.backgroundLight} ${style.dark}` : `${style.backgroundLight} ${style.light}`}>
      ...
      <div className={style.browserStatusLight}>
        ...
        <div className={theme === 'dark' ? `${style.tabControlsContainer} ${style.dark}` : `${style.tabControlsContainer} ${style.light}`}>
          <div className={theme === 'dark' ? `${style.leftTab} ${style.dark}` : `${style.leftTab} ${style.light}`}></div>
