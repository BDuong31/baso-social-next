...
export default function Emoji({ onEmojiSelect }: { onEmojiSelect: (emoji: string) => void }) {
  ...
  return (
    ...
    {isEmoji && (
      <div ref={emoijRef} style={{top: 'calc(55% + 8px)', transition: 'visibility .2s, opacity .2s'}} className='absolute left-[-8px] z-10 w-[372px] h-[201.5px] p-2 dark:bg-[#3b3b3b] bg-[#e6e6e6] dark:shadow-button-dark shadow-button rounded-button'>
        <div className='relative z-1'>
          <div>
          <div style={{top: 'calc(100% + 8px)'}} className="left-[-8px] relative w-[372px]">
